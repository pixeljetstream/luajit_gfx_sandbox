...
extern const GLchar* glErrorStringREGAL(GLenum error);
extern GLboolean glGetExtensionREGAL(const GLchar* ext);
extern GLboolean glIsSupportedREGAL(const GLchar* ext);
