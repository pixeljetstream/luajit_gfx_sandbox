...
SHADERCAPI void shaderc_compile_options_set_disassembly_mode(
    shaderc_compile_options_t options);
...
//  interface changes.
typedef struct shaderc_includer_response {
  const char* path;
  size_t path_length;
  const char* content;
...
typedef struct shaderc_includer_response* (*shaderc_includer_response_get_fn)(
...
typedef void(*shaderc_includer_response_release_fn)(
    void* user_data, struct shaderc_includer_response* data);
...
SHADERCAPI void shaderc_compile_options_set_includer_callbacks(
...
SHADERCAPI void shaderc_compile_options_set_preprocessing_only_mode(
    shaderc_compile_options_t options);
...
SHADERCAPI shaderc_spv_module_t shaderc_compile_into_spv(
...
// further operations.
SHADERCAPI void shaderc_module_release(shaderc_spv_module_t module);

// Returns true if the result in module was a successful compilation.
//SHADERCAPI bool shaderc_module_get_success(const shaderc_spv_module_t module); BUG MISSING
...
SHADERCAPI size_t shaderc_module_get_length(const shaderc_spv_module_t module);

// Returns the number of warnings generated during the compilation.
SHADERCAPI size_t shaderc_module_get_num_warnings(const shaderc_spv_module_t module);

// Returns the number of errors generated during the compilation.
SHADERCAPI size_t shaderc_module_get_num_errors(const shaderc_spv_module_t module);

// Returns the compilation status, indicating whether the compilation succeeded,
// or failed due to some reasons, like invalid shader stage or compilation
// errors.
SHADERCAPI shaderc_compilation_status shaderc_module_get_compilation_status(
...
// result char string.
SHADERCAPI const char* shaderc_module_get_bytes(const shaderc_spv_module_t module);

// Returns a null-terminated string that contains any error messages generated
// during the compilation.
SHADERCAPI const char* shaderc_module_get_error_message(const shaderc_spv_module_t module);
