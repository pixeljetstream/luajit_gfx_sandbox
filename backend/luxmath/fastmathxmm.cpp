...
#if defined(LUX_ARCH_X64) || defined (LUX_ARCH_X86)
#define USE_SSE2
#endif
...
/* natural logarithm computed for 4 simultaneous float 
   return NaN for x <= 0
*/
LUX_API v4sf lxFastLog_ps(v4sf x) {
#ifdef USE_SSE2
  v4si emm0;
#else
  v2si mm0, mm1;
...
/* evaluation of 4 sines at onces, using only SSE1+MMX intrinsics so
   ...
   deliver full speed.
*/
LUX_API v4sf lxFastSin_ps(v4sf x) { // any x
...
LUX_API v4sf lxFastCos_ps(v4sf x) { // any x
...
LUX_API void lxFastSinCos_ps(v4sf x, v4sf *s, v4sf *c) {
