...
extern "C"{
  ...
  typedef enum lxGLAddressMode_e{
    LUXGL_ADDRESS_REPEAT = GL_REPEAT,
    LUXGL_ADDRESS_CLAMP = GL_CLAMP_TO_EDGE,
    LUXGL_ADDRESS_BORDER = GL_CLAMP_TO_BORDER,
    LUXGL_ADDRESS_MIRROR = GL_MIRRORED_REPEAT,
    LUXGL_ADDRESSES,
  }lxGLAddressMode_t;
  ...
  typedef enum lxGLStencilSupport_e{
    LUXGL_STENCILSUPPORT_ARB,
    LUXGL_STENCILSUPPORT_ATI,
    LUXGL_STENCILSUPPORT_EXT,
    LUXGL_STENCILSUPPORTS,
  }lxGLStencilSupport_t;
